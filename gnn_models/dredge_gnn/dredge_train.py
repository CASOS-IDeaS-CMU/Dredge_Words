...
import pandas as pd
from gnns.dredge_import import import_seo_links, dredge_import
...
if __name__ == '__main__':
    ...
    train_loaders, valid_loader, test_loader, unlabeled_loader = dredge_import(edge_path, attr_path, embedding_path, sm_edge_path, label_path, user_attrs = TEXT_ATTRS)
...
uh = pd.read_csv('wgbd/politifact_serp.csv')
