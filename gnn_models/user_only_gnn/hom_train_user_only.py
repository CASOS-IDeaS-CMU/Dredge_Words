...
import pandas as pd
from gnns.users_only import node_masker_n2v_curriculum
...
embedding_path = 'embeddings/emb_users_only.npy'
...
if __name__ == '__main__':
    ...
    train_loaders, valid_loader, test_loader = node_masker_n2v_curriculum(edge_path, attr_path, embedding_path, sm_edge_path, label_path, binary_labels = BINARY_LABELS)
...
final.to_csv('results/user_only_feat_curr.csv', index = False)
